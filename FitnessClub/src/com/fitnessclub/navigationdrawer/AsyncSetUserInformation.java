...
public class AsyncSetUserInformation extends AsyncTask<String, Void, String> {

	Context context;

	public AsyncSetUserInformation(Context ctx) {
		this.context = ctx;
	}
	...
	protected void onPreExecute() {
		...
		Dialog.setMessage("Bilgileriniz iþleniyor...");
		Dialog.show();
	}
	...
	protected void onPostExecute(String result) {
		...
		if (result.equalsIgnoreCase("true")) {
			Toast.makeText(context, "Kayýt Baþarýlý.!", Toast.LENGTH_SHORT)
					.show();
		} else {
			Toast.makeText(context, "Kayýt Baþarýsýz.!", Toast.LENGTH_SHORT)
					.show();
		}
	}
	...
	protected String doInBackground(String... params) {
		String setUserInfo_url = "http://www.cbuwptema.esy.es/setUserInformation.php";
